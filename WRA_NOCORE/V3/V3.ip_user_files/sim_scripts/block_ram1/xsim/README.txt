...
#
# Generated by export_simulation on Tue Oct 22 17:38:29 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './block_ram1.sh' script.

./block_ram1.sh -reset_run
...
./block_ram1.sh -noclean_files

For more information on the script, please type './block_ram1.sh -help'.
