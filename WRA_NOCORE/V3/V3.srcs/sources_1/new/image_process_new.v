...
always @ (posedge pclk)
	begin
		if(!rst | frame0_flag==1'b1)
			...
			byte_flag_cnt<=16'd1;
		else if((frame3_flag==1'b1) && (byte_flag_cnt>16'd640))
			byte_flag_cnt<=16'd1;
//		else if((frame3_flag==1'b1) && (href==1'b1) && ( byte_flag_neg ==1'b1)&&((byte_flag_cnt <= 16'd1280)) )
else if((frame3_flag==1'b1) && (href==1'b1) && ( byte_flag ==1'b1)&&((byte_flag_cnt <= 16'd640)) )
...
else if(frame3_flag==1'b1 && (byte_flag_cnt % 5==0) && (byte_flag==1'b1) && address1<=14'd7168)//640/5  *56
...
//			address2<=10'd1;
//		else if(frame4_flag==1'b1 &&  (gray_word1_index +1) % 28==0    )
//			address2<=address2+229;//640/5*2-27
//		else if(frame4_flag==1'b1 && ( gray_word1_index<=784))
//			address2<=address2+1'b1;
//	end
