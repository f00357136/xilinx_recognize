...
assign result=IdentifiedNum[3:0];
 ...
 //led5   验证   DMARead_cnt_en  灯亮的时候FIFO数据输出到识别模块；
assign led5=DMARead_cnt_en;      

//led6   验证   CamEmpty  开始读数据时为0，设定为灯亮
assign led6=!CamEmpty;
