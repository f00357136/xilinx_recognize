...
HD_PWD='E:/vivado_workspace/20190923_sim_ok/WRA_NOCORE/V3/V3.runs/mult_lut_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_lut.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_lut.tcl
