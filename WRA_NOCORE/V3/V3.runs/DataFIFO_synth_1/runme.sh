...
HD_PWD='E:/vivado_workspace/20190930_test/WRA_NOCORE/V3/V3.runs/DataFIFO_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DataFIFO.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DataFIFO.tcl
